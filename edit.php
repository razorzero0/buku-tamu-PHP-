...
<div class="container mt-3">
   <div class="col-md-6 offset-md-3">
     ...
     <div class="form-group">
       ...
       <textarea name="alamat" id="alamat" class="form-control" row="3"><?php echo $data['alamat'] ?></textarea>
     </div>
     <div class="form-group">
       <label for="komentar">Komentar</label>
       <textarea name="komentar" id="komentar" class="form-control" row="3"><?php echo $data['komentar'] ?></textarea>
     </div>
     <div class="form-group">
